 ...
 */
#define jtr_lock(fd, type, mode) \
	real_lock(fd, type, mode, __FUNCTION__, __FILE__, __LINE__)

#define jtr_unlock(fd) \
	real_unlock(fd, __FUNCTION__, __FILE__, __LINE__)
...
extern int real_lock(int fd, int type, int mode,
                     const char *function, const char *file, int line);
extern void real_unlock(int fd,
                        const char *function, const char *file, int line);
